/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ab2246ea54036fa0500a78968ccade10)
// Runtime types generated with workerd@1.20250508.0 2024-11-13 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		FROM_WRANGLER_CONFIG: "hello from wrangler config";
		FROM_DEV_VARS_FILE: string;
		ASSETS: Fetcher;
	}
}
